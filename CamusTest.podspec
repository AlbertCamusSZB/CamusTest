...
Pod::Spec.new do |s|
  s.name             = 'CamusTest'
  s.version          = '0.1.0'
  s.summary          = 'A short description of CamusTest.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/szbgecui@163.com/CamusTest'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'szbgecui@163.com' => 'szbgecui@163.com' }
  s.source           = { :git => 'https://github.com/szbgecui@163.com/CamusTest.git', :tag => s.version.to_s }
